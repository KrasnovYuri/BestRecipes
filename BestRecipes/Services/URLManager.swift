...
class URLManager {
    ...
    func createURL (cuisine: Cuisine.RawValue, numberLimit: Int) -> URL? {
        URL(string: "https://api.spoonacular.com/recipes/complexSearch?apiKey=" + apiKey + "&cuisine=" + cuisine + "&number=\(numberLimit)" + "&sort=popularity" )
    }
    //get random dishes
